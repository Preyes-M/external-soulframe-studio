...
const addOns: AddOn[] = [
  {
    id: 'addon_photos',
    name: 'Extra 10 Photos',
    description: 'Additional edited photos',
    price: 1500,
  },
  {
    id: 'addon_album',
    name: 'Premium Album',
    description: '12x18 inch hardcover album',
    price: 3500,
  },
  {
    id: 'addon_retouch',
  ...
  { id: 'addon_prints', name: 'Canvas Prints', description: 'Set of 3 canvas prints', price: 2500 },
  {
    ...
    description: '2-3 minute highlight video',
    price: 4000,
  },
];
            ...
            <div className="flex items-start justify-between mb-3">
              ...
              <div
                className={`w-6 h-6 rounded-full border-2 flex items-center justify-center flex-shrink-0 ${
                  selected.includes(addon.id) ? 'bg-primary border-primary' : 'border-border'
                }`}
              >
